...
def ins():
    ...
    p2=Label(instr,text = """2. Students' Names and Registration Numbers which are scraped will be printed in the Reference Box one below the other for users' reference . The excel sheet created will be saved in the given location in the "path" Text Box .""").place(x = 80,y = 140)
